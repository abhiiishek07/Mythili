    ...
    <div className="p-4 flex items-center">
      <div className="max-w-6xl w-full mx-auto border rounded-md my-4 p-4">
        ...
        <div className="text-base text-gray-700">
          <p className="mb-4">
            Your privacy is important to us. It is [Your Real Estate Website]'s
            policy to respect your privacy regarding any information we may
            collect from you across our website, [Website URL], and other sites
            we own and operate.
          </p>
          ...
          <h2 className="text-lg font-semibold mb-2">3. Log Data</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            hard drive. Our website uses these "cookies" to collect information
            and to improve our website. You have the option to either accept or
