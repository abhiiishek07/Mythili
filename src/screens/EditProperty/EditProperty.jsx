...
const EditProperty = ({ data }) => {
  ...
  const checkEmptyFields = () => {
    ...
    if (!formData.amenities) emptyFields.push("Amenities");
    if (!formData.brochure) emptyFields.push("Brochure");
    ...
    if (!formData.type) emptyFields.push("Type");
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-3">
      <div className="w-full max-w-4xl p-8 bg-white rounded-lg shadow-lg my-10 gap-4 flex flex-col">
        <h2 className="text-2xl font-bold mb-4">EditProperty</h2>
        <div>
        ...
        <div>
          ...
          {formData.video && ( // Check if video data exists
            <div className="mb-2">
              <span className="text-blue-500">Current Video:</span>
              <video controls className="ml-1">
          ...
          <div className="grid grid-cols-4 gap-x-8 gap-y-2">
            {AMENITIES.map((item) => (
              ...
              >
                ...
                {formData.amenities.includes(item.id.toString()) ? (
                  <input
                    type="checkbox"
                    id={item.id}
                    value={item.id}
        ...
        <div>
          ...
          {formData.brochure && (
            <div className="mb-2">
              <span className="text-blue-500">Current Brochure:</span>
              <a
                role="button"
